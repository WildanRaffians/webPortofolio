          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12 w-full max-w-6xl px-4">
            ...
            <div className="flex flex-col justify-start items-center p-5">
              ...
              <div className="flex flex-row gap-2">
                {/* Instagram */}
                <a href="https://www.instagram.com/wildanraffians/" target="_blank" className="w-[110px] h-[110px] outline-none border-none bg-white dark:bg-gray-700 rounded-md shadow-lg transition-all duration-200 ease-in-out hover:scale-110 hover:bg-[#cc39a4] dark:hover:bg-[#cc39a4] group flex items-center justify-center">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/in/wildanhafizhraffianshar2003" target="_blank" className="w-[110px] h-[110px] outline-none border-none bg-white dark:bg-gray-700 rounded-md shadow-lg transition-all duration-200 ease-in-out hover:scale-110 hover:bg-[#0A66C2] dark:hover:bg-[#0A66C2] group flex items-center justify-center">
              ...
              <div className="flex flex-row gap-2">
                {/* GitHub */}
                <a href="https://github.com/WildanRaffians" target="_blank" className="w-[110px] h-[110px] outline-none border-none bg-white dark:bg-gray-700 rounded-md shadow-lg transition-all duration-200 ease-in-out hover:scale-110 hover:bg-black dark:hover:bg-black group flex items-center justify-center">
                  <svg className="fill-black group-hover:fill-white" height={30} width={30} viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* YouTube */}
                <a href="https://www.youtube.com/@wildanhafizhraffianshar3743" target="_blank" className="w-[110px] h-[110px] outline-none border-none bg-white dark:bg-gray-700 rounded-md shadow-lg transition-all duration-200 ease-in-out hover:scale-110 hover:bg-[#FF0000] dark:hover:bg-[#FF0000] group flex items-center justify-center">
