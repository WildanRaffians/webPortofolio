    ...
    <div className={`navbar fixed w-full transition-all ${scrollActive}`}>
        <div className="container mx-auto px-4">
            <div className="navbar-box flex items-center justify-between">
                ...
                shadow-lg shadow-slate-300 bg-sky-400 text-white transition-all`}>
                ...
                <div className="social flex items-center gap-2">
                    <a href="#social" className="bg-sky-400 px-5 py-2 rounded-full text-white font-bold hover:bg-sky-500 transition-all">Sosial Media</a>
                    <i class="ri-menu-line text-3xl md:hidden block" onClick={handleClick}></i>
                </div>
            </div>
        </div>
    </div>
